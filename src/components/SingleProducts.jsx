        ...
        <div className='grid lg:grid-cols-2 gap-5 bg-white p-4 rounded-lg'>
            ...
            <div className='flex flex-col justify-center gap-y-8'>
                ...
                <div className='flex items-center gap-x-5'>
                    ...
                    {
                        productQuantity > 0 && <div className='flex justify-center w-fit flex-1 items-center '> <Button className='w-[20%]' onClick={() => dispatch(decreaseQuantity(product))}>less</Button><p className='w-[10%] text-center font-bold'> {productQuantity} </p><Button className='w-[20%]' onClick={() => dispatch(increaseQuantity(product))}>more</Button> </div>
                    }
                </div>
